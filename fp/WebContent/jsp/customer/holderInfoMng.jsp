    ...
    <div id="tb">
	   ...
	   <a href="javascript:openSearchDialog()" class="easyui-linkbutton"
        ...
        <div id="dlg" class="easyui-dialog"
            style="top:60px;left:80px;width: 700px;height:400px;padding:10px 10px;" closed="true"
            buttons="#dlg-buttons">
            <form method="post" id="fm_cust">
                <table cellspacing="8px;">
                    ...
                    <tr>
                        ...
                        <td>                        	
							...
							<select name="relationType" id="relationType" 
	                            ...
	                            id="sex" style="width: 154px;" editable="false"
	                            panelHeight="auto"  required="true">
								<option value="1" selected>户主</option>
							</select>
                    ...
                    <tr>
                        ...
                        <td colspan='4'><input type="text" id="faddr" name="faddr" size=83/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan=4><div>
                        	<textarea style='font-size:13px' id="descb" 
                        		name="descb" rows="1" cols="70" size=1000></textarea>
