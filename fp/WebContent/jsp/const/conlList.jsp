...
<div>
    ...
    <div id="tb">
        <a href="javascript:openDialog(false)" class="easyui-linkbutton"
            iconCls="icon-tip">查询详情</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    ...
	    <div id="dlg" class="easyui-dialog"
	        style="top:10px;left:80px;width: 700px;height:400px;padding:10px 10px;" closed="true"
	        buttons="dlg_buttons">
