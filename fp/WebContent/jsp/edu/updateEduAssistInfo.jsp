...
function submitInfo(){
	var url = "<%=basePath %>/edu/addEduAssistInfo.do?flaged=m";
    $("#fm_edu").form("submit", {
        url : url,
        onSubmit : function() {
...
function openEduModifyDialog(){
    ...
    var row = selectedRows[0];
    $("#dlg-edu-assist").dialog("open").dialog("setTitle", "修改教育救助信息");
...
<!-- <div style='font-size:10px'><span>请选择需要删除的数据</span></div> -->
<body style="margin: 1px" onload="initData(null)">
<div>
    <table id="datagrid_edu_info"></table>
</div>
    <div id="tb_edu_update">
        <a href="javascript:openEduModifyDialog()" class="easyui-linkbutton"
            iconCls="icon-edit">修改教育救助信息</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
